...
import { NumberInput, RangeInput, Title, XYInput } from 'modules/ui'
import { ControlsTable, ShapeControls } from 'modules/box-shadow'
  ...
  return (
    <div className={css.root}>
      <div className={css.controls}>
        ...
        <div className={css.boxShadowControls}>
